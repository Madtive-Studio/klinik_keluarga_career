...
return [
    ...
    'profile' => [
        ...
        'skills_hint' => 'Add your medical or technical skills one by one to the list below.',
        'skills_label' => 'Skill / Competency',
        'skills_placeholder' => 'Type a skill (e.g., Nursing, Medical Care, Pharmacy, MS Office)',
        'skills_add_btn' => 'Add',
        'skills_empty_list' => 'No skills added to the list yet.',
