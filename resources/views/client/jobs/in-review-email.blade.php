...
<head>
	...
	<title>Status Lamaran Kamu: Sedang Dalam Review</title>
	<style>
		body {
...
<body style="background-color: #f9f9f9; margin: 0; padding: 20px;">
	<div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); overflow: hidden;">
		...
		<div style="padding-left: 20px; padding-right: 20px; padding-block: 1em; color: #333333;">
			<h2 style="font-size: 20px; text-align: center; color: #2F55D4;">Status Lamaran Kamu: Sedang Dalam Review</h2>
			...
			<p>Saat ini, lamaran kamu sedang dalam proses peninjauan oleh tim kami. Kami akan segera menghubungi kamu jika ada pembaruan lebih lanjut.</p>
