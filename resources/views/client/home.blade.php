@extends('client.layouts.main', ['navbarType' => 'default'])
@section('title', 'Beranda')
@section('content')
	<section class="bg-home" style="background: url('https://img.freepik.com/premium-photo/workspace-wide-light-office_280538-7380.jpg?semt=ais_hybrid') no-repeat center center; background-size: cover;">
