		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-7">
					...
					<div class="job-detail border rounded p-4">
						<div class="job-detail-content">
							<img src="images/featured-job/img-4.png" alt="" class="img-fluid float-start me-md-3 me-2 mx-auto d-block">
							<div class="job-detail-com-desc overflow-hidden d-block">
								...
								<p class="text-muted mb-0"><i class="mdi mdi-laptop me-2"></i>{{ $job->type }} | {{ $job->experience }}</p>
								<p class="text-muted mb-0"><i class="mdi mdi-account me-2"></i>{{ $formattedAppliesTotal }} orang melamar pekerjaan ini</p>
							</div>
						</div>
					</div>
							...
							<div class="col-lg-12">
								<div class="job-detail border rounded p-4">
									<div class="job-detail-content">
										...
										<div class="mb-3" id="form_new_document">
											<input type="file" name="new_document" class="form-control" id="new_document">
											@error('new_document')
												<span class="text-danger fw-bold">{{ $message }}</span>
											@enderror
										</div>
										<div class="mb-3" id="form_document_id">
				...
				<div class="col-lg-4 col-md-5 mt-4 mt-sm-0">
					<div class="job-detail border rounded p-4">
						<h5 class="text-muted text-center pb-2"><i class="mdi mdi-info me-2"></i>Informasi</h5>
